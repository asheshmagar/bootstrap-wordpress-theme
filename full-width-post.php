							...
							<div class="single-post nobottommargin">
								...
								<div class="entry clearfix">
									...
									<ul class="entry-meta clearfix">
										<li><i class="icon-calendar3"></i> <?php the_time(); ?></li>
										<li>
										...
										<li><i class="icon-folder-open"></i> <a
												href="#"><?php the_category( ', ' ); ?></a>
										</li>
										<li><a href="#"><i class="icon-comments"></i> <?php comments_number( '0' ); ?>
											</a></li>
									</ul><!-- .entry-meta end -->
											...
											<div class="mpost clearfix">
												...
												<div class="entry-c">
													...
													<ul class="entry-meta clearfix">
														...
														<li><i class="icon-comments"></i> <?php comments_number(); ?>
														</li>
													</ul>
